...
gulp.task("clean-web", function () {
  return gulp.src("./examples/dist", { read: false }).pipe(clean());
});

gulp.task("deploy-web", function () {
  return gulp.src("./examples/dist/**/*").pipe(ghPages());
});

gulp.task("copy-css", function () {
  return gulp.src("./examples/**/*.css").pipe(gulp.dest("./examples/dist/css"));
});

gulp.task("copy-html", function () {
  return gulp.src("./examples/index.html").pipe(gulp.dest("./examples/dist/"));
});
